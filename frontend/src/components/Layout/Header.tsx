...
const Header = () => {
    ...
    return (
            <div className="flex justify-between px-1 py-2 w-full max-w-5xl mx-auto">
                <Link to="/" className="text-xl font-display">
                    <div className="text-xl font-display"><span className="mr-2">[</span>
                        ...
                        <span className="text-[#ff0041]">T y p e </span>
                        <span className="inline-block  
               p-[0.15rem] rotate-15 ml-[0.18rem] bg-[#ff0041] ">R</span>
                ...
                <div className="flex justify-center items-center gap-6 font-header text-lg">
                    <div className="group cursor-pointer p-2 -m-2">
                        ...
                        <span className="absolute h-1 w-0 bg-[#ff0041] bottom-0 left-0 
